...
|**xref:data-fabric.adoc[Cerbos Data Fabric]** — Data and integration layer
...
* xref:data-fabric.adoc[Data Fabric] — Authorization data enrichment and infrastructure integrations.
