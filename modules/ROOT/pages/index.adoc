...
Embedded policy decision points:: Evaluate policies locally in browsers, edge functions, and other JavaScript environments using WebAssembly. Filter bundles by resource, action, scope, or role to expose only what each client needs.
