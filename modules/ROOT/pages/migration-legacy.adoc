...
Migration involves four phases:
...
. Navigate to **Policy stores** and click **New store**
...
. Select the policy store created in Phase 1
. Click **Create**
...
[[update-service-pdps]]
== Phase 3: Update service PDP configuration
...
Use the deployment ID and credentials from Phase 2.
...
== Phase 4: Update embedded PDP integration
