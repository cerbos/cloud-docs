...
Audit log data can be integrated with SIEM and UEBA systems by configuring the secondary pipe output described above to forward log entries to your existing log aggregation infrastructure.
