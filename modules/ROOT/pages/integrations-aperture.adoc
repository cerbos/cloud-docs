...
. Replace `<paste-your-tailscale-auth-key-here>` with the Tailscale auth key generated in the previous step
...
[horizontal]
`TS_AUTHKEY`:: The Tailscale auth key with the appropriate tag assigned. Generate this from https://login.tailscale.com/admin/settings/keys[Tailscale admin settings].
