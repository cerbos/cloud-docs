...
****
GitHub has a https://docs.github.com/en/developers/webhooks-and-events/webhooks/webhook-events-and-payloads#push[known limitation] that if someone pushes multiple tags at once, connected applications won't be notified - including Cerbos Cloud - so no builds will be generated.
****
