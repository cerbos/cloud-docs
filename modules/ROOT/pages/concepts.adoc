...
Embedded PDP::: A WebAssembly module that executes authorization logic locally within an application, without network calls to a Cerbos PDP. Embedded PDPs are suited for browser applications, edge functions, and other environments where latency or connectivity constraints make server-side authorization impractical. See xref:deployments-epdp-rules.adoc[Embedded PDPs].
--
