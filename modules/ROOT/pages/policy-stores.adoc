...
Policies:: Browse the current contents of the store in a file tree. Select a version from the dropdown to view historical snapshots. Click **Open in playground** to experiment with the policies in an isolated environment.
